...
Accepted identities, recipient names, reference links and publication caveats below describe this batch's snapshot; use the later quality report for `Y`/`N` judgments.
