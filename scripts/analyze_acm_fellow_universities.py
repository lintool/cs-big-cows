...
ALIAS_PATTERNS = [
    ...
    (r"\bUW\b|University of Washington", "University of Washington"),
    ...
    (r"\bUniv\.? of Wisconsin[- ]Madison\b|University of Wisconsin[- ]Madison", "University of Wisconsin-Madison"),
