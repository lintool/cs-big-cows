...
DEFAULT_DATA = APP_ROOT / "acm-fellows" / "acm_fellows.csv"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--data", type=Path, default=DEFAULT_DATA, help="Path to acm_fellows.csv or a bundled *-data.js file.")
